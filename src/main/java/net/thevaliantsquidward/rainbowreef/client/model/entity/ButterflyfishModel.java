package net.thevaliantsquidward.rainbowreef.client.model.entity;// Made with Blockbench 4.12.5
...
import net.thevaliantsquidward.rainbowreef.client.animation.ButterflyfishAnimations;
...
public class ButterflyfishModel extends ReefFishModel<ReefRenderState> {
	...
	public ButterflyfishModel(ModelPart root) {
		...
		this.setupBaseAnimations(root, ButterflyfishAnimations.SWIM, ButterflyfishAnimations.FLOP);
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		applyTransformation(root, pos -> PartPose.offset(0.5F, 21.5F, 0.5F));
