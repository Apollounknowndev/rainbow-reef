...
import net.thevaliantsquidward.rainbowreef.client.animation.ButterfishAnimations;
...
public class ButterfishModel extends ReefFishModel<ReefRenderState> {
	...
	public ButterfishModel(ModelPart root) {
		...
		this.setupBaseAnimations(root, ButterfishAnimations.SWIM, ButterfishAnimations.FLOP);
	}
