...
public record CoralBlockSet(Block deadBlock, Block block, Block deadPlant, Block plant, Block deadFan, Block fan, Block deadWallFan, Block wallFan) {
    public static CoralBlockSet create(String name, MapColor color) {
        ...
        Block plant = ReefBlocks.register(name + "_coral", properties -> new CoralPlantBlock(deadBlock, properties.mapColor(color)), Blocks.BRAIN_CORAL);

        Block deadFan = ReefBlocks.registerStandalone("dead_" + name + "_coral_fan", BaseCoralFanBlock::new, Blocks.DEAD_BRAIN_CORAL_FAN);
        Block fan = ReefBlocks.registerStandalone(name + "_coral_fan", properties -> new CoralFanBlock(deadBlock, properties.mapColor(color)), Blocks.BRAIN_CORAL_FAN);
        ...
        Block wallFan = ReefBlocks.registerStandalone(name + "_coral_wall_fan", properties -> new CoralWallFanBlock(deadBlock, properties.mapColor(color)), Blocks.BRAIN_CORAL_WALL_FAN);
