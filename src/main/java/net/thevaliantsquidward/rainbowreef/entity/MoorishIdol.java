...
public class MoorishIdol extends ReefSchoolingFishEntity<MoorishIdol.Variant> {
    public final AnimationState swimAnimationState = new AnimationState();
    public final AnimationState landAnimationState = new AnimationState();

    public MoorishIdol(EntityType<? extends ReefSchoolingFishEntity> type, Level level) {
        super(type, level, 500);
    ...
    public static AttributeSupplier setAttributes() {
        return Animal.createMobAttributes().add(Attributes.MAX_HEALTH, 8D).add(Attributes.MOVEMENT_SPEED, 1D).build();
    }
    ...
    public DataComponentType<Variant> getVariantComponent() {
        return ReefDataComponents.MOORISH_IDOL_VARIANT;
    }
    ...
    public Variant selectVariant(ServerLevelAccessor levelAccessor, RandomSource random) {
        return random.nextFloat() <= 0.001F ? Variant.SILVER : Variant.DEFAULT;
    }
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(ReefItems.MOORISH_IDOL_BUCKET);
    }
