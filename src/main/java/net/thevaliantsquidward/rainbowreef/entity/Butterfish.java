...
public class Butterfish extends ReefSchoolingFishEntity<Butterfish.Variant> {
    public final AnimationState swimAnimationState = new AnimationState();
    public final AnimationState landAnimationState = new AnimationState();

    public Butterfish(EntityType<? extends Butterfish> type, Level level) {
