...
public class Pipefish extends ReefFishEntity<Pipefish.Variant> {
    public final AnimationState swimAnimationState = new AnimationState();
    public final AnimationState flopAnimationState = new AnimationState();

    public Pipefish(EntityType<? extends WaterAnimal> type, Level level) {
    ...
    public DataComponentType<Variant> getVariantComponent() {
        return ReefDataComponents.PIPEFISH_VARIANT;
    }
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(ReefItems.PIPEFISH_BUCKET);
    }

    public static AttributeSupplier setAttributes() {
        return Animal.createMobAttributes().add(Attributes.MAX_HEALTH, 4D).add(Attributes.MOVEMENT_SPEED, 0.45D).build();
    }
    ...
    public enum Variant implements ReefVariant {
        JANNS(1, "janns"),
        MULTIBANDED(2, "multibanded"),
        ORANGESTRIPED(3, "orangestriped"),
        BLUESTRIPED(4, "bluestriped"),
        PINK(5, "pink"),
        GREEN(0, "green");
