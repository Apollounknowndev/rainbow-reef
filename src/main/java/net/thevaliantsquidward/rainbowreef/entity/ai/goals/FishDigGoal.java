...
public class FishDigGoal extends Goal {
    ...
    public FishDigGoal(ReefBaseMob fisdh, int digtime, TagKey<Block> whitelist) {
    ...
    public void start() {
        ...
        if (!(this.fims instanceof AbstractCrab)) {
    ...
    public void tick() {
        ...
        if (this.fims instanceof AbstractCrab && this.fims.blockPosition().below().equals(this.digPos)) {
